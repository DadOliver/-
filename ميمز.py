...
def mody(client, message):
    message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("《🪳》", callback_data="shady")]])
    )

@app.on_callback_query(filters.command("shady"))
...
def zeqe(client, message):
    message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("《🐖》", callback_data="mohamedl")]])
    )

@app.on_callback_query(filters.command("mohamedl"))
...
def namlo(client, message):
    message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("《🦗》", callback_data="oliverll")]])
    )

@app.on_callback_query(filters.command("oliverll"))
