...
@app.on_message(
    filters.command(["مميزات","مميزات أو أر "], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس أو أر ميوزك\n
⩹━★⊷⌯⌞ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗢&𝗥 ⌝⌯⊶★━⩺

★قايمه مميزات سورس أو أر 
