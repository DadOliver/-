...
※ [في حال مواجهه اي مشكله انضم هنا](hhttps://t.me/R1_O9)\n [𝗦𝗢𝗨𝗥𝗖𝗘 𝗢&𝗥](https://t.me/R1_O9)
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="or"),
                ],
                ...
                [
                    InlineKeyboardButton(
                        "‹ المطور ›", url="https://t.me/DadOliver"
                    )
                ],
            ]
        ),
...
InlineKeyboardButton(" member keyboard ", callback_data="R1_O9"),
                ...
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/DadOliver"
                    )
                ],
            ]
        ),
...
async def cbguides(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f""" **※Welcome \n
※Show members keyboard Send /O&R \n\n
※Show entertainment keyboard send /OR**
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 Go Back", callback_data="english")]]
        ),
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع أو أر من هن : @DadOliver @l_k_l_I **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""※ مرحبا بك \n ※ لتفعيل كيبورد الاعضاء ارسل /O&R \n ※ لتفعيل كيبورد التسليه ارسل /OR""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("العودة", callback_data="bcmds")]]
        ),
    )
